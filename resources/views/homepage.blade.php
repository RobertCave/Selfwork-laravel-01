...
<html lang="en">
 ...
 <body class="d-flex justify-content-center align-items-center vh-100" style="background-color: #d1d4d7;">
    ...
    <div class="text-center">
        ...
        <div class="mt-4">
            ...
            <a href="/" class="btn disabled btn-sm" tabindex="-1" role="button" aria-disabled="true">Link alla Homepage</a>
