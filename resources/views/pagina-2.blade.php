...
<html lang="en">
 ...
 <body class="d-flex justify-content-center align-items-center vh-100" style="background-color: #b7e091;">

    <div class="text-center">
        <!-- Titolo al centro -->
        <h1 class="display-3">Pagina - 2  </h1>

        <!-- Pulsanti sotto -->
        <div class="mt-4">
            <a href="/pagina-1" class="btn btn-primary btn-sm " tabindex="-1" role="button" >Link alla pagina 1</a>
            <a href="/pagina-2" class="btn  btn-sm disabled" tabindex="-1" role="button">Link alla pagina 2</a>
